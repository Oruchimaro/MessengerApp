...
const ConversationItem = ({ conversation, online, selectedConversation }) => {
    ...
    return (
        <Link
            ...
            preserveState
            className={
                "flex items-center gap-2 p-2 text-gray-300 transition-all border-l-4 cursor-pointer conversation-item hover:bg-black/30" +
                classes +
        ...
        >
            ...
            >
                ...
                {conversation.last_message && (
                    <p className="overflow-hidden text-xs text-ellipsis text-nowrap">
                        {conversation.last_message}
                    </p>
                )}
                {conversation.is_admin && conversation.is_user && (
